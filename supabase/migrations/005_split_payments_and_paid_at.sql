-- ============================================
-- Emmanuel Pharmacy — Migration 005: Split Payments & Paid At Timestamp
...
-- 2. Trigger to automatically set paid_at = now() when status becomes 'paid'
...
CREATE TRIGGER trg_set_order_paid_at
  ...
  FOR EACH ROW
  EXECUTE FUNCTION public.check_late_night_order(); -- safe reference
